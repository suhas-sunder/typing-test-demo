    ...
    <div className="my-20 flex flex-col items-center justify-center gap-8 font-nunito text-defaultblue">
      <header className="max-w-[1200px]">
        ...
        <p className="flex flex-col gap-4 py-2">
          This Cookie Policy explains how http://freetypingcamp.com ("Company,"
          "we," "us," and "our") uses cookies and similar technologies to
          recognize you when you visit our website at https://freetypingcamp.com
      ...
      <main className="flex max-w-[1200px] flex-col gap-8">
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            http://freetypingcamp.com) are called "first-party cookies." Cookies
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>Provider: freetypingcamp.com</p>
